...
const About = () => {
  return (
    <div className="bg-gradient-to-r from-pink-200 via-red-100 to-pink-200 min-h-screen bg-white text-gray-800">
      <div
        className="h-72 bg-cover bg-center flex items-center justify-center"
      >
        <div className="bg-gradient-to-r from-pink-300 via-red-400 to-pink-300 bg-opacity-50 p-8 rounded-md text-center">
          <h1 className="text-4xl font-bold text-grey-600">About XStore</h1>
          <p className="text-grey-600 mt-2">Where fashion meets elegance.</p>
        </div>
      </div>
